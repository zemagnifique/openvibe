...
export class World
{
	...
	constructor(worldScenePath?: any)
	{
		...
		if (worldScenePath !== undefined)
		{
			...
			loadingManager.onFinishedCallback = () =>
			{
				...
				Swal.fire({
					...
					footer: '<a href="https://github.com/zemagnifique/openvibe" target="_blank">GitHub page</a>',//<a href="https://discord.gg" target="_blank">Discord server</a>',
		...
		else
		{
			...
			Swal.fire({
				icon: 'success',
				title: 'Hello world!',
				text: 'New OpenVibeworld was succesfully initialized. Enjoy the blueness of the sky.',
				buttonsStyling: false
			});
		}
	...
	private generateHTML(): void
	{
		...
		$(`	<div id="loading-screen">
				...
				<h1 id="main-title" class="sb-font">OpenVibe 0.1</h1>
				<div class="cubeWrap">
					<div class="cube">
		...
		$(`	<div id="ui-container" style="display: none;">
				<div class="github-corner">
					<a href="https://github.com/zemagnifique/openvibe" target="_blank" title="Fork me on GitHub">
